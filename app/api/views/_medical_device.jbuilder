encoded_brand_name = medical_device.brand_name.force_encoding("US-ASCII")
if !encoded_brand_name.valid_encoding?
  encoded_brand_name.scrub!("")
end
...
json.device_name "#{encoded_brand_name}, #{medical_device.gmdn_pt_name}"
