class ApiService < Sinatra::Base
  ...
  put '/v2/encounter_notes/:encounter_id/merge_transcriptions' do
    ...
    begin
      access_token, encounter_id, business_entity_id = get_oauth_token, params[:encounter_id], params[:business_entity_id]
      request_body = get_request_JSON
      data  = CCAuth::OAuth2Client.new.authorization access_token

      merge_transcription_url = webservices_uri "/encounter_notes/#{business_entity_id}"
